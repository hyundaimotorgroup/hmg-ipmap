...
/**
 * Scenario-based test for LocationService.createLocation with isFromLocationRequest true covering
 * all 24 scenarios: - Global Scope (G1-G8): Admin user creating locations - Client Scope (C1-C8):
 * Client user with fallback to Global - SubClient Scope (S1-S8): SubClient user with fallback chain
 * (SubClient → Client → Global)
 */
@ExtendWith(MockitoExtension.class)
class CreateLocationScenarioTest {
    ...
    void setUp() {
        ...
        // Mock findLocationByGeonameIdAndScope - use lenient (single result, filters by geonameId
        // AND scope)
        lenient()
    ...
    class GlobalScopeScenarios {
        ...
        void testG1_AllNew_CreateAll() {
            ...
            Map<LocationLevel, LocationDto> response =
                    locationService.createLocation(adminUser, locationMap, true);
        ...
        @Test
        @DisplayName("G4: All exist → Update all")
        void testG4_AllExist_UpdateAll() {
        ...
        @Test
        @DisplayName("G5: Only Country & Continent exist → Create City, Rest updated")
        void testG5_CountryAndContinentExist_CreateCityUpdateRest() {
        ...
        @Test
        @DisplayName("G6: Only Continent exists → Create City & Country, Continent not update")
        void testG6_OnlyContinentExists_CreateCityAndCountryNoUpdateContinent() {
        ...
        @Test
        @DisplayName("G7: City & Continent exist → Update both, Create Country")
        void testG7_CityAndContinentExist_UpdateBothCreateCountry() {
        ...
        @Test
        @DisplayName("G8: Only Country exists → Create City & Continent, Update Country")
        void testG8_OnlyCountryExists_CreateCityAndContinentUpdateCountry() {
    ...
    class ClientScopeScenarios {
        ...
        @Test
        @DisplayName("C1: All are new → create")
        void testC1_AllNew_Create() {
            ...
            // When
            Map<LocationLevel, LocationDto> response =
                    locationService.createLocation(clientUser, locationMap, true);
        ...
        @Test
        @DisplayName("C2: Only City exists → Update City, Create Country & Continent")
        void testC2_OnlyCityExists_UpdateCityCreateRest() {
        ...
        @Test
        @DisplayName("C3: City & Country exist → Update both, Create Continent")
        void testC3_CityAndCountryExist_UpdateBothCreateContinent() {
        ...
        @Test
        @DisplayName("C4: All exist → Update all")
        void testC4_AllExist_UpdateAll() {
        ...
        @Test
        @DisplayName("C5 Country & Continent exist → Create City, Update rest")
        void testC5_CountryAndContinentExist_CreateCityUpdateRest() {
        ...
        @Test
        @DisplayName("C6: Only Continent exists → Create City & Country, Update Continent")
        void testC6_OnlyContinentExists_CreateCityAndCountryUpdateContinent() {
        ...
        @Test
        @DisplayName("C7: City & Continent exist → Update both, Create Country")
        void testC7_CityAndContinentExist_UpdateBothCreateCountry() {
        ...
        @Test
        @DisplayName("C8: Only Country exists → Create City & Continent, Update Country")
        void testC8_OnlyCountryExists_CreateCityAndContinentUpdateCountry() {
    ...
    class SubclientScopeScenarios {
        ...
        @Test
        @DisplayName("S1: All are new -> create in SubClient scope")
        void testS1_AllNew_FallbackThenCreateInSubClientScope() {
            // Given
            LocationDto continent = buildLocationDto("AS", 1L);
            LocationDto country = buildLocationDto("JP", 2L);
            LocationDto city = buildLocationDto("Tokyo", 3L);
            ...
            // When
            Map<LocationLevel, LocationDto> response =
                    locationService.createLocation(subClientUser, locationMap, true);
        ...
        @Test
        @DisplayName("S2: Only City exists → Update City, Create Country & Continent")
        ...
        @Test
        @DisplayName("S3: City & Country exist → Update both, Create Continent")
        void testS3_CityAndCountryExist_UpdateBothCreateContinent() {
        ...
        @Test
        @DisplayName("S4: All exist → Update all")
        void testS4_AllExist_UpdateAll() {
        ...
        @Test
        @DisplayName("S5: Country & Continent exist → Create City, Update rest")
        void testS5_CountryAndContinentExist_CreateCityUpdateRest() {
        ...
        @Test
        @DisplayName("S6: Only Continent exists → Create City & Country, Update Continent")
        void testS6_OnlyContinentExists_CreateCityAndCountryUpdateContinent() {
        ...
        @Test
        @DisplayName("S7: City & Continent exist → Update both, Create Country")
        void testS7_CityAndContinentExist_UpdateBothCreateCountry() {
        ...
        @Test
        @DisplayName("S8: Only Country exists → Create City & Continent, Update Country")
        void testS8_OnlyCountryExists_CreateCityAndContinentUpdateCountry() {
